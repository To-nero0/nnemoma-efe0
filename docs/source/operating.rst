[nnemoma-efe0] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [nnemoma-efe0] container is NOT running**.

.. tip::
   You must have your [nnemoma-efe0] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/To-nero0/tonerodocker/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/To-nero0/tonerodocker  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env READTHEDOCS=<Enter your readthedocs token>  \-\-env EXTERNALPORT=32913  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME=To-nero0  \-\-env GITPASSWORD=<Enter personal access token>  \-\-env DOCKERUSERNAME=anthopadua  \-\-env DOCKERPASSWORD=<Enter your docker hub password>  \-\-env MQTTUSERNAME=Anthopadua  \-\-env MQTTPASSWORD=<Enter your mqtt password>  \-\-env KAFKACLOUDUSERNAME=  \-\-env KAFKACLOUDPASSWORD=<Enter your API secret>  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=52405
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=37705
...
It can be accessed by entering: http://localhost:48943
...
.. important::
   http://localhost:52405/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:52405/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:52405/<html file>
...
[nnemoma-efe0] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/To-nero0/tonerodocker/tree/main/tml-airflow/dags/tml-solutions/nnemoma-efe0
...
.. important::
   solution_preprocessing_ai_dag-nnemoma-efe0
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=37705, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41429, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35463, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35837, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38601, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43471, HPDEHOST=127.0.1.1, HPDEPORT=32917, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41283

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9550-nnemoma-efe0,solution_preprocessing_dag-nnemoma-efe0, python-preprocess-6522-nnemoma-efe0,solution_preprocessing_dag-nnemoma-efe0, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
